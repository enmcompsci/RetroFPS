...
#define UE_PROJECT_NAME RetroFPSTutorial
#define UE_TARGET_NAME RetroFPSTutorialEditor
#define UE_MODULE_NAME "RetroFPSTutorial"
...
#define RETROFPSTUTORIAL_API DLLEXPORT
